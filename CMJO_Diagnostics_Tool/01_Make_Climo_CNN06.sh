...
#PBS -o MakeClimo_f.e.FTORCHmjo_CNNmjo_DT.out
#PBS -e MakeClimo_f.e.FTORCHmjo_CNNmjo_DT.out
#PBS -q casper
...
#Array of filenames and corresponding variable names
declare -a FILES=(
    "f.e.FTORCHmjo_CNNmjo_DT.cam.h1.TTEND_TOT.1979010100000-1990122200000.nc TTEND_TOT"
)
