...
def generate_samples(gen_func, args, samples:int=1, output_dtype=np.float64):
...
def generate_virtual_samples(gen_func, args, samples:int=1, output_dtype=np.float64, sample_chunksize:int=None):
