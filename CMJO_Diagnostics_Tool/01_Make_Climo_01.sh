...
#PBS -o MakeClimo_f.e.FTORCHmjo_CNTRLmjo_DT.out
#PBS -e MakeClimo_f.e.FTORCHmjo_CNTRLmjo_DT.out
#PBS -q casper
#PBS -l select=1:ncpus=10:mem=210GB
#PBS -m a
...
#Array of filenames and corresponding variable names
declare -a FILES=(
    "f.e.FTORCHmjo_CNTRLmjo_DT.cam.h1.U.1979010100000-1990122200000.nc U"
)
