...
#PBS -o VertRMSE_GPUQ.out
#PBS -e VertRMSE_GPUQ.out
#PBS -q main
...
dir_exp="/glade/derecho/scratch/wchapman/ADF/f.e.FTORCHmjo_meanGPU_exp001/ts/"
...
prefix_exp="f.e.FTORCHmjo_meanGPU_exp001"
...
declare -a variables=("Q")
declare -a file_parts=("Q.plev.197901-201012.nc")
