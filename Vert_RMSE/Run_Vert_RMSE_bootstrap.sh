...
#PBS -o VertRMSE_01.out
#PBS -e VertRMSE_01.out
#PBS -q casper
...
prefix_exp="f.e.FTORCHmjo_CNNmjo"
...
declare -a variables=("Q" "T" "U" "V")
declare -a file_parts=("Q.plev.197901-201012.nc" "T.plev.197901-201012.nc" "U.plev.197901-201012.nc" "V.plev.197901-201012.nc")
