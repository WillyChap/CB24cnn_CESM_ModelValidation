...
def main():
    ...
    for bs in range(bs_nummy):
        fout = f'./Bootstrapped/{args.fin_exp}_AllSeason_vertical_RMSE_{bs:04}.pkl'
        ...
        for SEAS in ['DJF','MAM','JJA','SON']:
            ...
            for levs in DS_cntrl_SA_BS['lev']:
                ...
                w1 = wgt_rmse(DS_cntrl_SA_BS[args.var_exp].sel(lev=lv,season=SEAS),DS_obs_SA_BS[args.var_obs].sel(lev=lv,season=SEAS),weights_cos)
                w2 = wgt_rmse(DS_exp_SA_BS[args.var_exp].sel(lev=lv,season=SEAS),DS_obs_SA_BS[args.var_obs].sel(lev=lv,season=SEAS),weights_cos)
